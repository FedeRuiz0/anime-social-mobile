import { EventEmitter, NativeModule, SharedObject, SharedRef } from 'expo-modules-core/src/polyfill/CoreModule';
import uuid from 'expo-modules-core/src/uuid/index.web';
...
export * from 'expo-modules-core/src/ts-declarations/global';
